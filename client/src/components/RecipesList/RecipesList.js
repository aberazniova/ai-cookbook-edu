...
function RecipesList() {
  const recipes = [
    { id: 1, name: 'Fresh Avocado and Quinoa Salad' },
    ...
    { id: 5, name: 'Teriyaki Chicken with Rice and Vegetables' },
    { id: 6, name: 'Coffee Dessert with Chocolate Chips and Nuts' },
